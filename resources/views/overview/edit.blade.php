...
@section('content')
<div class="px-5">
  <h2 class="text-2xl flex font-bold text-dark"> update Overview</h2>
        ...
        <table class=" divide-y-2 divide-gray-200 bg-white text-sm">
          <thead class="ltr:text-left rtl:text-right">
            <tr>
              ...
              <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">Create_at</th>
          ...
          <tbody class="divide-y divide-gray-200">
            <tr>
              ...
              <td>
                <form action="{{ route('overview.update.submit', ['id' =>  $value -> id]) }}" method="GET">
                  @csrf
